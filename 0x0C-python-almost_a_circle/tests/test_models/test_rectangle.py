...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_temp_rectangle_2(self):
    ...
    def test_incorrect_amount_params(self):
        """ Test error raise with 1 arg passed """
        with self.assertRaises(TypeError):
            temp = Rectangle(1)

    def test_incorrect_amount_params_1(self):
        """ Test error raised with no args passed """
        with self.assertRaises(TypeError):
            temp = Rectangle()

    def test_access_private_params(self):
        """ Trying to access to a private attribute """
        temp = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            temp.__width

    def test_access_private_params_2(self):
        """ Trying to access to a private attribute """
        temp = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            temp.__height

    def test_access_private_params_3(self):
        """ Trying to access to a private attribute """
        temp = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            temp.__x

    def test_access_private_params_4(self):
        """ Trying to access to a private attribute """
        temp = Rectangle(1, 1)
        with self.assertRaises(AttributeError):
            temp.__y

    def test_valide_params(self):
        """ Trying to pass a string value """
        with self.assertRaises(TypeError):
            temp = Rectangle("2", 2, 2, 2, 2)

    def test_valide_params_2(self):
        """ Trying to pass a string value """
        with self.assertRaises(TypeError):
            temp = Rectangle(2, "2", 2, 2, 2)

    def test_valide_params_3(self):
        """ Trying to pass a string value """
        with self.assertRaises(TypeError):
            temp = Rectangle(2, 2, "2", 2, 2)

    def test_valide_params_4(self):
        """ Trying to pass a string value """
        with self.assertRaises(TypeError):
            temp = Rectangle(2, 2, 2, "2", 2)
    ...
    def test_value_params_1(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
            temp = Rectangle(1, 0)

    def test_value_params_2(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
            temp = Rectangle(1, 1, -1)

    def test_value_params_3(self):
        """ Trying to pass invalid values """
        with self.assertRaises(ValueError):
